...
import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, ComposedChart, Area, AreaChart, ScatterChart, Scatter } from "recharts";
import { TrendingUp, TrendingDown, Zap, Shield, Eye, Clock } from "lucide-react";

const threatDetectionData = [
  { time: "00:00", threats: 2, severity: "low", responseTime: 3.2 },
  { time: "04:00", threats: 0, severity: "none", responseTime: 0 },
  { time: "08:00", threats: 5, severity: "medium", responseTime: 2.8 },
  { time: "12:00", threats: 8, severity: "high", responseTime: 1.5 },
  { time: "16:00", threats: 3, severity: "low", responseTime: 3.1 },
  { time: "20:00", threats: 1, severity: "low", responseTime: 2.9 },
];
